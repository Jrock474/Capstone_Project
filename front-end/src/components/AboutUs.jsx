  ...
  return (
    <>
      ...
      <div>
        ...
        <div className='AboutUsNav'><img src={"../images/AboutUs.PNG"} style={{ height: 150 }} /></div>
        ...
        <div className='AnthonyContainer'>
          ...
          <div className='EthanText'>
            <p style={{alignSelf:'center'}}>Hey! My name is Ethan Shulman, I'm a full stack web developer / Music Artist / Producer / Sound Engineer based in Atlanta, GA. We came together to make a game similar to Tamagotchi but with our own twist on it. All the kaijus are designed by our talented teammate Anthony. This is the first video game I've been a part of and I'm looking forward to all the games I'll make in the future! All the sounds you hear on each endpoint are produced by me, hope you guys enjoy what we've accomplished!
            <br />
            <div className='aboutUsLinks'>
            <a href="https://my-portfolio-sage-mu-23.vercel.app/" className='aboutUsLinks'>Portfolio</a>       <a href="https://drive.google.com/file/d/1dV47QE0k4rgNkujwa1xCNiRAALpDRHPX/view?usp=sharing" className='aboutUsLinks'>Resume</a>       <a href="https://github.com/ethanShulman" className='aboutUsLinks'>Github</a>          <a href="https://www.linkedin.com/in/ethan-shulman-338889104/" className='aboutUsLinks'>LinkedIn</a>
            </div>
            </p>
          </div>
          </div>
